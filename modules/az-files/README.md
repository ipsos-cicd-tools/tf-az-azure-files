...
| <a name="input_default_share_level_permission"></a> [default\_share\_level\_permission](#input\_default\_share\_level\_permission) | Default share-level permission for AD-joined file shares. Supports principle of least privilege (ISO 27001 A.8.2). | `string` | `"StorageFileDataSmbShareElevatedContributor"` | no |
...
| <a name="output_private_endpoint_id"></a> [private\_endpoint\_id](#output\_private\_endpoint\_id) | Resource ID of the file storage private endpoint. |
